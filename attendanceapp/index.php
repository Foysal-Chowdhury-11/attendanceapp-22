...
<body class="p-4">
    ...
    <div class="card bg-white p-8 md:p-12 rounded-xl w-full max-w-md text-center">
        ...
        <select id="university-select" 
            ...
            <option value="state_university">State University of Technology</option>
            <option value="metro_college">Metropolitan Community College</option>
            <option value="coastal_uni">Coastal University</option>
            <option value="tech_institute">Advanced Tech Institute</option>
    ...
    <script>
        ...
        const loginPage = 'auth_login.php'; 
